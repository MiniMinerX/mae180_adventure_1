function [dydt, d_min_out] = two_sat_sim(~, y, mu, J2, Rearth, A2M, CD)
    persistent min_distance burn_executed;
    ...
    % Output the current minimum distance encountered.
    d_min_out = min_distance;
